...
- [ ] **[T-1.1]** Initialize .NET 8 Solution (`MuktoAin.sln` 4 Projects + References) — *Tultul* `[Blocked by: S-Setup.1] [Unblocks: T-1.2]`
- [ ] **[T-1.2]** Implement All 9 Enums in `MuktoAin.Domain/Enums/` — *Tultul* `[Blocked by: T-1.1] [Unblocks: T-1.3, A-1.1]`
- [ ] **[T-1.3]** Implement All 14 Domain Entities in `MuktoAin.Domain/Entities/` — *Tultul* `[Blocked by: T-1.2] [Unblocks: T-1.4, A-1.1]`
- [ ] **[T-1.4]** Define Repository & Service Interfaces in Domain/Application — *Tultul* `[Blocked by: T-1.3] [Unblocks: T-1.5, A-2.1]`
...
- [ ] **[T-1.10]** Manual SQL Server Full-Text Search (FTS) SSMS Script — *Tultul* `[Blocked by: T-1.6] [Unblocks: T-2.2]`
